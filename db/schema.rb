...
ActiveRecord::Schema.define(version: 0) do
  ...
  add_index 'customers', %w(username password), name: 'ix_cust_user_password', unique: true, using: :btree
  ...
  add_index 'orderlines', %w(orderid orderlineid), name: 'ix_orderlines_orderid', unique: true, using: :btree
  ...
  add_index 'products', %w(category special), name: 'ix_prod_cat_special', using: :btree
